...
type Module = typeof import("../_app.gardens.$gardenSlug.plants.$plantId.js")

type Info = GetInfo<{
  file: "routes/_app.gardens.$gardenSlug.plants.$plantId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_app.gardens.$gardenSlug.plants.$plantId.js");
}];
