          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <Form method="post">
              ...
              >
                ...
                {showCareTooltip && (
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-72 rounded-md bg-gray-800 px-3 py-2 text-xs text-white pointer-events-none z-10">
                    When generating AI care instructions the plant species and variety and the garden location are sent to the AI in order to get more accurate information
