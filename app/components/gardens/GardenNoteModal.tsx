...
export type GardenNoteModalState =
  | { mode: "create" }
  | { mode: "view"; note: Note }
  | { mode: "edit"; note: Note };

interface GardenNoteModalProps {
  state: GardenNoteModalState | null;
  onClose: () => void;
...
export function GardenNoteModal({ state, onClose, onEdit }: GardenNoteModalProps) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <fetcher.Form method="post">
                <input type="hidden" name="intent" value="delete_garden_note" />
